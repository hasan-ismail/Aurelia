using Aurelia.Core.Media;
using Aurelia.Core.Media.Control;
using Aurelia.Helpers;
using System;
using System.Diagnostics;
using System.Windows.Media.Imaging;

namespace Aurelia.DesignTime
{
    internal class MockMediaSession : MediaSession
    {
        public MockMediaSession()
        {
            ...
            MediaSourceIcon = new BitmapImage(PackUriHelper.GetAbsoluteUri("/Assets/Images/Aurelia_16.png"));
