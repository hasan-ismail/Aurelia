...
;
; Build with:
;   iscc /DAppVersion=0.10.1 /DArch=x64 /DPayloadDir=..\publish\win-x64 Aurelia.iss
...
SetupIconFile=..\Aurelia\Assets\Logo.ico
...
Filename: "{sys}\taskkill.exe"; Parameters: "/F /IM {#AppExe}"; Flags: runhidden; RunOnceId: "StopAurelia"
